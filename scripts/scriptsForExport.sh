...
sudo -i -u postgres psql anti_corona_crm -c "COPY ( SELECT 
	...
	is_found::text,
	is_infected::text,
	(SELECT name FROM \"Region\" WHERE \"Region\".id=\"Patient\".region_id LIMIT 1) AS region,
	(SELECT name FROM \"PatientStatus\" WHERE \"PatientStatus\".id=\"Patient\".status_id LIMIT 1) AS status,
	(SELECT name FROM \"Hospital\" WHERE \"Hospital\".id=\"Patient\".hospital_id LIMIT 1) AS hospital,
	(SELECT name FROM \"Country\" WHERE \"Country\".id=(SELECT country_id FROM \"Address\" WHERE \"Address\".id=\"Patient\".home_address_id LIMIT 1) LIMIT 1) AS home_country,
	...
	(SELECT name FROM \"Country\" WHERE \"Country\".id=\"Patient\".citizenship_id LIMIT 1) AS citizenship,
	(SELECT name FROM \"Country\" WHERE \"Country\".id=\"Patient\".country_of_residence_id LIMIT 1) AS country_of_residence,
	(SELECT name FROM \"TravelType\" WHERE \"TravelType\".id=\"Patient\".travel_type_id LIMIT 1) AS travel_type,
	job,
	job_position,
	(SELECT name FROM \"Country\" WHERE \"Country\".id=(SELECT country_id FROM \"Address\" WHERE \"Address\".id=\"Patient\".job_address_id LIMIT 1) LIMIT 1) AS job_country,
	...
	(SELECT name FROM \"Country\" WHERE \"Country\".id=(SELECT country_id FROM \"VisitedCountry\" WHERE \"VisitedCountry\".patient_id=\"Patient\".id LIMIT 1) LIMIT 1) AS visited_country,
	...
	(SELECT name FROM \"Country\" WHERE \"Country\".id=(SELECT from_country_id FROM \"FlightCode\" WHERE \"FlightCode\".id=(SELECT flight_code_id FROM \"FlightTravel\" WHERE \"FlightTravel\".patient_id=\"Patient\".id  LIMIT 1)  LIMIT 1) LIMIT 1) AS flight_from_country,
	...
	(SELECT name FROM \"Country\" WHERE \"Country\".id=(SELECT to_country_id FROM \"FlightCode\" WHERE \"FlightCode\".id=(SELECT flight_code_id FROM \"FlightTravel\" WHERE \"FlightTravel\".patient_id=\"Patient\".id LIMIT 1) LIMIT 1) LIMIT 1) AS flight_to_country,
...
sudo -i -u postgres psql anti_corona_crm -c "COPY ( SELECT 
	...
	(SELECT name FROM \"Country\" WHERE \"Country\".id=(SELECT from_country_id FROM \"Train\" WHERE \"Train\".id=(SELECT train_id FROM \"TrainTravel\" WHERE \"TrainTravel\".patient_id=\"Patient\".id LIMIT 1) LIMIT 1) LIMIT 1) AS train_from_country,
	...
	(SELECT name FROM \"Country\" WHERE \"Country\".id=(SELECT to_country_id FROM \"Train\" WHERE \"Train\".id=(SELECT train_id FROM \"TrainTravel\" WHERE \"TrainTravel\".patient_id=\"Patient\".id LIMIT 1) LIMIT 1) LIMIT 1) AS train_to_country,
...
sudo -i -u postgres psql anti_corona_crm -c "COPY ( SELECT 
	...
	(SELECT name FROM \"Region\" WHERE \"Region\".id=(SELECT region_id FROM \"BlockpostTravel\" WHERE \"BlockpostTravel\".patient_id=\"Patient\".id LIMIT 1) LIMIT 1) AS blockpost_travel_region
